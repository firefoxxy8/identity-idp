class Analytics
  ...
  MULTI_FACTOR_AUTH_OTP_PREFERENCE_SELECTED = 'Multi-Factor Authentication: otp preference selected'.freeze
  ...
  USER_REGISTRATION_OTP_PREFERENCE_VISIT = 'User Registration: otp preference visited'.freeze
